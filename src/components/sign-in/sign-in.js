...
import { emailSignInStart } from '../../reducer/user/user.actions';
  ...
  const SignIn = ({ emailSignInStart }) => {
   ...
   <h2>Demo <span className='h2Changer'>Login Now!</span> </h2>
   <span>Login to <span className='h2Changer'>Check Auth Demo</span></span>
